...
android {
    namespace = "com.example.animalhandbook"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.animalhandbook"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
 /*   implementation("com.github.deano2390:FlowTextView:2.0.5")*/
    ...
    implementation(files("C:\\Oles\\Projects\\Library\\FlowTextView-master\\gradle\\wrapper\\gradle-wrapper.jar"))
